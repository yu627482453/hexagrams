...
package cn.bipher.hexagrams.feign.sentinel.ext;
...
public final class SentinelFeign {
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		public Feign build() {
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				private Object getFromContext(String name, String type, Class<?> fallbackType, Class<?> targetType) {
					Object fallbackInstance = feignClientBuilder.forType(fallbackType,name);
		...
		public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
			...
			this.feignClientBuilder = (FeignClientBuilder) this.applicationContext.getBean(FeignClientBuilder.class);
		}
