...
package cn.bipher.hexagrams.feign.sentinel.handle;
...
public class GlobalBizExceptionHandler {
	...
	public ApiResponse handleBodyValidException(MethodArgumentNotValidException exception) {
		List<FieldError> fieldErrors = exception.getBindingResult().getFieldErrors();
		log.warn("参数绑定异常,ex = {}", fieldErrors.get(0).getDefaultMessage());
		return ApiResponse.fail(String.format("%s %s", fieldErrors.get(0).getField(), fieldErrors.get(0).getDefaultMessage()));
	}
