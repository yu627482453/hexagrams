...
import cn.bipher.hexagrams.redis.core.annotation.CacheDel;
import cn.bipher.hexagrams.redis.core.annotation.CacheDels;
import cn.bipher.hexagrams.redis.core.annotation.CachePut;
import cn.bipher.hexagrams.redis.core.annotation.Cached;
import cn.bipher.hexagrams.redis.lock.DistributedLock;
import cn.bipher.hexagrams.redis.operation.CacheDelOps;
import cn.bipher.hexagrams.redis.operation.CacheDelsOps;
import cn.bipher.hexagrams.redis.operation.CachePutOps;
import cn.bipher.hexagrams.redis.operation.CachedOps;
...
public class CacheStringAspect {
	...
	@Pointcut("execution(@(@cn.bipher.hexagrams.redis.core.annotation.MetaCacheAnnotation *) * *(..))")
