...
package cn.bipher.hexagrams.xss;

import cn.bipher.hexagrams.xss.config.XssProperties;
import cn.bipher.hexagrams.xss.core.*;
...
@ConditionalOnProperty(prefix = XssProperties.PREFIX, name = "enabled",
...
public class XssAutoConfiguration implements WebMvcConfigurer {
	...
	public Jackson2ObjectMapperBuilderCustomizer xssJacksonCustomizer(
			XssProperties properties, XssCleaner xssCleaner) {
